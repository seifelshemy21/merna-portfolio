...
const Experience = () => {
    return (
        <section id="experience" className="py-20 bg-ivory-dark">
            <div className="max-w-5xl mx-auto px-6">
                <SectionTitle title="Experience" subtitle="Professional Journey" />

                <div className="relative border-l-2 border-champagne ml-3 md:ml-6 space-y-8 md:space-y-12">
                    <div className="relative pl-6 md:pl-12">
                        {/* Dot */}
                        <div className="absolute -left-[9px] top-0 w-5 h-5 rounded-full bg-rose border-4 border-ivory shadow-sm"></div>

                        <div className="bg-ivory-light p-5 sm:p-6 md:p-8 rounded-2xl shadow-sm border border-champagne/40 hover:shadow-md transition-shadow">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-3 md:gap-0">
                                <h3 className="text-lg md:text-xl font-bold text-charcoal flex items-start md:items-center gap-2">
                                    <Briefcase size={20} className="text-rose shrink-0 mt-0.5 md:mt-0" />
                                    <span>Junior UI/UX Designer</span>
                                </h3>
                                <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-sm text-taupe">
                            ...
                            <ul className="space-y-2 md:space-y-3 text-sm md:text-base text-charcoal/85 list-disc list-outside ml-4 mt-4 md:mt-6 leading-relaxed">
                                ...
                                <li>Built wireframes and high-fidelity designs using <strong className="text-charcoal font-semibold">Figma</strong>, ensuring pixel-perfect execution.</li>
