...
const About = () => {
    return (
        <section id="about" className="py-20 bg-ivory-dark z-20">
            <div className="max-w-4xl mx-auto px-6">
                <SectionTitle title="About Me" subtitle="Who I Am" />

                <div className="grid md:grid-cols-1 gap-12">
                    <div className="space-y-6 text-lg text-charcoal/90 leading-relaxed">
                        <p>
                        ...
                        <p>
                            Currently, I work at <strong className="text-rose font-bold">Kroo</strong>, where I collaborate closely with developers and product managers to translate complex requirements into seamless user flows. I believe in the power of minimalism and strong hierarchy to guide users effortlessly through their journey.
                        </p>
                        <p>
